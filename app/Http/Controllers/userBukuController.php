...
class userBukuController extends Controller
{
    ...
    {
        $buku = buku::orderBy('id', 'desc')->where('id_user', Auth::user()->id)->get();
        $getBuku = buku::with('getKategori','getUser')->get();
        return view('dashboard_user.pages.buku', compact('buku','getBuku'));
    }
    public function deleteBukuDashboard($id)
    {
        ...
        return redirect()->route('user.buku.dashboard');
    }
    public function viewAddBukuDashboard()
    {
        $kategori = Kategori::all();
        return view('dashboard_user.pages.tambah.tambah_buku' ,compact('kategori'));
    }
    public function addBukuDashboard(Request $request)
    {
        ...
        return redirect()->route('user.buku.dashboard')->with('success', 'Buku berhasil ditambahkan.');
    }
    ...
    public function viewEditBukuDashboard($id)
    {
        ...
        $kategori = Kategori::all();
        return view('dashboard_user.pages.edit.edit_buku', compact('buku', 'kategori','user'));
    }
    ...
    public function editBukuDashboard(Request $request, $id)
    {
        ...
        return redirect()->route('user.buku.dashboard')->with('success', 'Buku berhasil diedit.');
    }
}
