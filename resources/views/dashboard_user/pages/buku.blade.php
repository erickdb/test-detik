...
@section('content')
    <div class="container">
        ...
        <div class="d-flex mb-3">
            <a href="{{ route('user.buku.view.add') }}" class="btn btn-primary ms-auto">Tambah</a>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if ($row->file)
                                <span>{{ $row->file }}</span>
                                <br>
                                <a href="{{ route('user.fileBuku.download', $row->file) }}" data-toggle="modal"><i
                        ...
                        <td class="text-center">
                            <div class="d-flex align-items-center justify-content-center gap-3">
                                <a href="{{ route('user.buku.view.edit',$row->id) }}" class=""><i
                                        class="bi bi-pencil-square" data-toggle="tooltip" title="Edit"></i></a>

                                <form class="delete" method="POST" action={{ route('user.buku.delete',['id' => $row->id]) }}
